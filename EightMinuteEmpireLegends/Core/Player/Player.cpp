...
Player::Player(std::string name) : playerName(name), coin(0), availableArmies(0), availableCities(0) {}
...
int Player::ComputeAbilityScore() {
	...
	for (cardAbilityIter = this->hand.begin(); cardAbilityIter != this->hand.end(); cardAbilityIter++) {
